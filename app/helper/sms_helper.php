...
class sms_helper extends Model
{
	...
	function __construct(argument)
	{
        ...
        if ($lang == 1) {
            ...
            $_url = 'http://sms.malath.net.sa/httpSmsProvider.aspx' . "?username=" . "e-store" . "&password=" . "0558585343" . "&mobile=" . $moblie . "&sender=" . 'E-STORE' . "&unicode=U&message=" . $message . "";
        } else if ($lang == 2){
            $_url = 'http://sms.malath.net.sa/httpSmsProvider.aspx' . "?username=" . "e-store" . "&password=" . "0558585343" . "&mobile=" . $moblie . "&sender=" . 'E-STORE' . "&unicode=E&message=" . $message . "";
        }
