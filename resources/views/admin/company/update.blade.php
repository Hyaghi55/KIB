...
@endif
  ...
  <div class="col-6">
<form  class="container" action='/admin/{{Request::segment(2)}}/update/{{$company->id}}' method="POST" enctype="multipart/form-data">
  @csrf

        <div class="form-group">
    <label for="exampleInputEmail1">{{Request::segment(2)}} name</label>
    <input name="name" class="form-control" id="comment" required value="{{$company->name}}">
    ...
    <input name="link" class="form-control" id="comment" required value="{{$company->link}}">
